...
class Application_ui(Frame):
    ...
    def createWidgets(self):
        ...
        self.Command3.place(relx=0.65, rely=0.789, relwidth=0.123, relheight=0.144)
        ...
        self.txtadd.place(relx=0.045, rely=0.789, relwidth=0.376, relheight=0.144)
        ...
        self.Command2.place(relx=0.469, rely=0.789, relwidth=0.123, relheight=0.144)
        ...
        self.Command1.place(relx=0.832, rely=0.592, relwidth=0.123, relheight=0.342)
